...
public class cartMainFrame extends JPanel {
    ...
    public cartMainFrame(List<Map<String, String>> cartBooks, int numBooks, List<Map<String, String>> allBooks) {
        ...
        int cols = 2; // use 2 products per row in cart
        ...
        TotalCartComponent totals = new TotalCartComponent(cartBooks, numBooks, this.allBooks, this.jsonPath);
        ...
        // Place totals at the top of the right column so it stays fixed while center content scrolls
        JPanel rightWrapper = new JPanel(new BorderLayout());
        rightWrapper.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 10, 20));
        rightWrapper.add(totals, BorderLayout.NORTH);
